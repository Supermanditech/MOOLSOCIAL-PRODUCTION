...
const workOpportunities = <WorkOpportunity>[
  WorkOpportunity(
    ...
    deadline: 'Open while 12 funded slots remain',
  ...
  WorkOpportunity(
    ...
    requiredWork: 'Creator Work',
    deadline: 'Open while 18 funded slots remain',
  ...
  WorkOpportunity(
    ...
    deadline: 'Open while 20 funded orders remain',
  ...
  WorkOpportunity(
    ...
    payout: 'Within 3 days',
    requiredWork: 'Creator Work',
    deadline: 'Delivery window confirmed after selection',
  ...
  WorkOpportunity(
    ...
    deadline: 'Next route time confirmed before acceptance',
  ...
  WorkOpportunity(
    ...
    payout: 'T+1 review',
    requiredWork: 'Freelancer Work',
    deadline: 'Open while verified activations remain',
  ...
  WorkOpportunity(
    ...
    deadline: 'Applications open · closing date confirmed on apply',
