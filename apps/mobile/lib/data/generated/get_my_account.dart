...
class GetMyAccountVariablesBuilder {
  ...
  Deserializer<GetMyAccountData> dataDeserializer = (dynamic json) =>
      GetMyAccountData.fromJson(jsonDecode(json));
...
class GetMyAccountAppUser {
  ...
  Map<String, dynamic> toJson() {
    ...
    json['status'] = accountStatusSerializer(status);
...
class GetMyAccountData {
  ...
  GetMyAccountData.fromJson(dynamic json)
    : appUser = json['appUser'] == null
          ? null
          : GetMyAccountAppUser.fromJson(json['appUser']);
  @override
  bool operator ==(Object other) {
    if (identical(this, other)) {
      return true;
