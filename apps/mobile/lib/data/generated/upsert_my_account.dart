...
class UpsertMyAccountVariablesBuilder {
  ...
  Deserializer<UpsertMyAccountData> dataDeserializer = (dynamic json)  => UpsertMyAccountData.fromJson(jsonDecode(json));
  Serializer<UpsertMyAccountVariables> varsSerializer = (UpsertMyAccountVariables vars) => jsonEncode(vars.toJson());
  Future<OperationResult<UpsertMyAccountData, UpsertMyAccountVariables>> execute() {
    return ref().execute();
  }

  MutationRef<UpsertMyAccountData, UpsertMyAccountVariables> ref() {
    UpsertMyAccountVariables vars= UpsertMyAccountVariables(displayName: _displayName,);
    return _dataConnect.mutation("UpsertMyAccount", dataDeserializer, varsSerializer, vars);
  }
}
...
class UpsertMyAccountAppUserUpsert {
  ...
  bool operator ==(Object other) {
    ...
    final UpsertMyAccountAppUserUpsert otherTyped = other as UpsertMyAccountAppUserUpsert;
...
class UpsertMyAccountData {
  ...
  appUser_upsert = UpsertMyAccountAppUserUpsert.fromJson(json['appUser_upsert']);
  @override
  bool operator ==(Object other) {
    if(identical(this, other)) {
      return true;
...
class UpsertMyAccountVariables {
  ...
  bool operator ==(Object other) {
    ...
    final UpsertMyAccountVariables otherTyped = other as UpsertMyAccountVariables;
