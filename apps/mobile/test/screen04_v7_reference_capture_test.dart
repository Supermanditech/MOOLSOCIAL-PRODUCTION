...
void main() {
  ...
  testWidgets('Screen 04 v7 identical-viewport comparison captures', (
    tester,
  ) async {
    ...
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-v7-videos-discovery-390x844.png');

    await tester.tap(find.text('5-minute morning mobility'));
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-v7-videos-watch-390x844.png');
    ...
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-v7-shorts-390x844.png');

    await tester.tap(find.byKey(const Key('screen04-rail-feed')));
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-v7-feed-390x844.png');

    await tester.tap(find.byKey(const Key('screen04-rail-create')));
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-v7-create-390x844.png');
    expect(tester.takeException(), isNull);
  }, skip: true); // Superseded by the frozen Screen 04 v8 reference.
}
