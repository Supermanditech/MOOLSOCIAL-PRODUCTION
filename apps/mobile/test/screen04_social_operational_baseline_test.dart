...
void main() {
  ...
  testWidgets('Screen 04 protected operational baseline captures', (
    tester,
  ) async {
    ...
    await tester.pumpAndSettle();
    await _capture(tester, 'screen04-operational-videos-watch-390x844.png');
    ...
    await _captureOverlay(
      tester,
      'screen04-operational-videos-channel-390x844.png',
    );
