...
void main() {
  ...
  testWidgets('FIX12 preserves truthful context-owned header actions', (
    tester,
  ) async {
  ...
  testWidgets('FIX12 remains contained at 320 px and 140 percent text', (
    tester,
  ) async {
  ...
  testWidgets('FIX12 reduced motion resolves to the stacked deep final frame', (
    tester,
  ) async {
    final session = BuyV2Session(core: BuySession());
    await tester.pumpWidget(_app(session, disableAnimations: true));
