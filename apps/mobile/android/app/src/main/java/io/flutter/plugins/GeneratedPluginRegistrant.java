...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.moolsocial.youtube_embedded_player_private_dev.YouTubeEmbeddedPlayerPrivateDevPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin youtube_embedded_player_private_dev, com.moolsocial.youtube_embedded_player_private_dev.YouTubeEmbeddedPlayerPrivateDevPlugin", e);
    }
  }
}
