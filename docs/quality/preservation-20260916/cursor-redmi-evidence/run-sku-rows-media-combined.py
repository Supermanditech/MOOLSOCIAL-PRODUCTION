...
before=e/'sku-rows-media-combined-before-01.json'
...
jobs=[
 ('sku-rows-media-combined-01','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-02','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!')
]
