...
before=e/'sku-media-navigation-before-05.json'
...
jobs=[
 ('sku-row-media-analysis-05','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart','No issues found!'),
 ('sku-media-grid-05','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid" --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-media-grid-visual-05" --reporter expanded','All tests passed!'),
 ('sku-row-swipe-05','test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "SKU swipe" --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-row-final-visual-05" --reporter expanded','All tests passed!')
]
...
print('Current analysis, media non-overlap and swipe qualification passed; 3044 source owners preserved.',flush=True)
