...
before=e/'sku-final-corrections-before-07.json'
...
visual=' --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-final-visual-07"'
jobs=[
 ('sku-final-analysis-07','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart test/ui_v2/buy/buy_v2_product_continuity_test.dart','No issues found!'),
 ('sku-final-return-07','test --no-pub test/ui_v2/buy/buy_v2_product_continuity_test.dart --name "R66 Compare returns through source|R66 Saved return retains the vertical browsing position" --reporter expanded','All tests passed!'),
 ('sku-final-badge-07','test --no-pub test/ui_v2/buy/buy_v2_scoped_cart_checkout_dock_continuity_test.dart --plain-name "R664 Saved badge fits"'+visual+' --reporter expanded','All tests passed!'),
 ('sku-final-screen-07','test --no-pub test/ui_v2/buy/buy_v2_screen_test.dart --name "R66 landscape .* retains usable product actions|Masala Ghar storefront is compact"'+visual+' --reporter expanded','All tests passed!'),
 ('sku-final-media-07','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid"'+visual+' --reporter expanded','All tests passed!')
]
