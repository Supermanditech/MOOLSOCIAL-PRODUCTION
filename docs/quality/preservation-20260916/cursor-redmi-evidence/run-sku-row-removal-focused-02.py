...
assert set(changed)=={'apps/mobile/lib/ui_v2/buy/buy_v2_catalogue.dart','apps/mobile/test/ui_v2/buy/buy_v2_partner_catalogue_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_screen_test.dart'},changed
...
before=e/'sku-row-removal-before-02.json'
...
jobs=[
 ('sku-row-removal-analysis-02','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart','No issues found!'),
 ('sku-row-removal-focused-02', 'test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "SKU swipe" --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-row-removal-visual-02" --reporter expanded','All tests passed!')
]
...
print('Row-removal analysis and focused swipe/visual checks passed; 3044 source owners preserved.',flush=True)
