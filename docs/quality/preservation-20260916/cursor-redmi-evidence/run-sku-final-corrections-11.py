...
before=e/'sku-final-corrections-before-11.json'
...
visual=' --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-final-visual-11"'
jobs=[
 ('sku-final-analysis-11','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart test/ui_v2/buy/buy_v2_product_continuity_test.dart','No issues found!'),
 ('sku-final-related-partner-11','test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "store catalogue exposes full products and exact related-store continuation" --reporter expanded','All tests passed!'),
 ('sku-final-related-screen-11','test --no-pub test/ui_v2/buy/buy_v2_screen_test.dart --name "Other stores cards carry decisions|Other store Cart closes both storefronts" --reporter expanded','All tests passed!'),
 ('sku-final-media-11','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid"'+visual+' --reporter expanded','All tests passed!')
]
...
print('Related-store and Saved media corrections passed; 3044 source owners preserved.',flush=True)
