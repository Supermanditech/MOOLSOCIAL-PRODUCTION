...
before=e/'sku-saved-media-before-10.json'
...
jobs=[('sku-saved-media-red-10','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid shop 430.0 1.0 store false saved long badge" --reporter expanded','All tests passed!')]
...
print('Saved long-badge media boundary completed; inspect actual outcome, not the runner label.',flush=True)
