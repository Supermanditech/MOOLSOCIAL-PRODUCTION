...
assert set(changed)=={'apps/mobile/lib/ui_v2/buy/buy_v2_catalogue.dart','apps/mobile/test/ui_v2/buy/buy_v2_partner_catalogue_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_screen_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_product_variant_selection_test.dart'},changed
...
before=e/'sku-media-navigation-before-01.json'
...
jobs=[
 ('sku-media-navigation-analysis-01','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart','No issues found!'),
 ('sku-media-grid-01','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid" --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-media-grid-visual-01" --reporter expanded','All tests passed!'),
 ('sku-media-existing-01','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart test/ui_v2/buy/buy_v2_product_actions_test.dart test/ui_v2/buy/buy_v2_product_content_test.dart test/ui_v2/buy/buy_v2_product_video_test.dart --reporter expanded','All tests passed!'),
 ('sku-row-connected-01','test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --name "SKU swipe|R5 paged|R5 store-first" --reporter expanded','All tests passed!'),
 ('sku-row-search-01','test --no-pub test/ui_v2/buy/buy_v2_screen_test.dart --plain-name "RV6 D018 paginated search" --reporter expanded','All tests passed!')
]
...
print('Media grid, existing media and affected navigation qualification passed; 3044 source owners preserved.',flush=True)
