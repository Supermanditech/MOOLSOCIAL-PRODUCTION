...
before=e/'sku-row-removal-before-05.json'
...
jobs=[
 ('sku-row-removal-focused-05', 'test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "SKU swipe" --reporter expanded','All tests passed!')
]
