...
assert set(changed)=={'apps/mobile/lib/ui_v2/buy/buy_v2_catalogue.dart','apps/mobile/test/ui_v2/buy/buy_v2_product_variant_selection_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_partner_catalogue_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_screen_test.dart'},changed
...
before=e/'sku-rows-media-combined-before-03.json'
...
jobs=[
 ('sku-row-media-analysis-06','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart','No issues found!'),
 ('sku-provider-refresh-06','test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "SKU provider names adaptive" --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-03','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-04','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!')
]
...
print('Both required row-removal and media combined runs passed; 3044 source owners preserved.',flush=True)
