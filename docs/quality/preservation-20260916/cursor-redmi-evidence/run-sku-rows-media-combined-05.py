...
before=e/'sku-rows-media-combined-before-05.json'
...
jobs=[
 ('sku-final-badge-visual-09','test --no-pub test/ui_v2/buy/buy_v2_scoped_cart_checkout_dock_continuity_test.dart --plain-name "R664 Saved badge fits at 320.0 / 1.0" --dart-define="BUY_R664_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-final-badge-visual-09" --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-05','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-06','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!')
]
...
print('Both required final row-removal/media combined runs passed; 3044 source owners preserved.',flush=True)
