...
before=e/'sku-final-corrections-before-12.json'
...
visual=' --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-final-visual-12"'
jobs=[
 ('sku-final-analysis-12','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart test/ui_v2/buy/buy_v2_product_continuity_test.dart','No issues found!'),
 ('sku-final-saved-badge-12','test --no-pub test/ui_v2/buy/buy_v2_scoped_cart_checkout_dock_continuity_test.dart --plain-name "R664 Saved badge fits" --reporter expanded','All tests passed!'),
 ('sku-final-store-density-12','test --no-pub test/ui_v2/buy/buy_v2_screen_test.dart --plain-name "Masala Ghar storefront is compact" --reporter expanded','All tests passed!'),
 ('sku-final-media-12','test --no-pub test/ui_v2/buy/buy_v2_product_variant_selection_test.dart --plain-name "SKU media grid"'+visual+' --reporter expanded','All tests passed!')
]
