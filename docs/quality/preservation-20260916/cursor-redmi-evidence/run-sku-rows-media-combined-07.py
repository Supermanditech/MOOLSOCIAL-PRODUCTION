...
before=e/'sku-rows-media-combined-before-07.json'
...
jobs=[
 ('sku-rows-media-combined-07','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!'),
 ('sku-rows-media-combined-08','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!')
]
