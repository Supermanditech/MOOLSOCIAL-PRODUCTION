...
before=e/'sku-media-navigation-before-04.json'
...
jobs=[
 ('sku-row-media-analysis-04','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart test/ui_v2/buy/buy_v2_product_variant_selection_test.dart','No issues found!'),
 ('sku-row-offers-04','test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "R5 paged published Offers journey" --reporter expanded','All tests passed!'),
 ('sku-row-search-04','test --no-pub test/ui_v2/buy/buy_v2_screen_test.dart --plain-name "RV6 D018 paginated search" --reporter expanded','All tests passed!')
]
...
print('Final changed-owner analysis, Offers recovery and search qualification passed; 3044 source owners preserved.',flush=True)
