...
assert set(changed)=={'apps/mobile/lib/ui_v2/buy/buy_v2_catalogue.dart','apps/mobile/lib/ui_v2/buy/buy_v2_views.dart','apps/mobile/test/ui_v2/buy/buy_v2_partner_catalogue_test.dart','apps/mobile/test/ui_v2/buy/buy_v2_screen_test.dart'},changed
...
before=e/'sku-navigation-combined-before-01.json'
...
jobs=[
 ('sku-navigation-final-analysis-01','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart lib/ui_v2/buy/buy_v2_views.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart','No issues found!'),
 ('sku-navigation-combined-01','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!'),
 ('sku-navigation-combined-02','test --no-pub '+tests+' --exclude-tags protected-reference --reporter expanded','All tests passed!')
]
...
print('Final analysis and both required twelve-record combined runs passed; 3044 source owners preserved.',flush=True)
