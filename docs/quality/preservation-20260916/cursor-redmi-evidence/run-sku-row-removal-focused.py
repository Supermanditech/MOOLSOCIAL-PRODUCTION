...
before=e/'sku-row-removal-before-01.json'
...
jobs=[
 ('sku-row-removal-analysis-01','analyze --no-pub lib/ui_v2/buy/buy_v2_catalogue.dart test/ui_v2/buy/buy_v2_partner_catalogue_test.dart test/ui_v2/buy/buy_v2_screen_test.dart','No issues found!'),
 ('sku-row-removal-focused-01', 'test --no-pub test/ui_v2/buy/buy_v2_partner_catalogue_test.dart --plain-name "SKU swipe" --dart-define=BUY_R663_VISUAL_CAPTURE=true --dart-define="BUY_R663_VISUAL_DIRECTORY=C:/GUARANTEED OUTCOME/MOOLSOCIAL-CURSOR-BUY-UAT-20260905/sku-metadata-redmi-20260914/sku-row-removal-visual-01" --reporter expanded','All tests passed!')
]
