...
$receipt=Join-Path $PSScriptRoot 'repeat-admission-negative.result.json'
...
Write-Output 'D014 admission: exact source accepted; five negative cases rejected; existing backend/egress self-tests passed.'
