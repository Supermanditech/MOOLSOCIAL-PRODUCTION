...
$folder = Join-Path $root 'apps/mobile/build/cursor-review-r66.22'
$apk = Join-Path $folder 'artifacts/uaw-cursor-redmi-rv6-language-20260914-device-review-debug.apk'
$provenance = Join-Path $folder 'artifacts/uaw-cursor-redmi-rv6-language-20260914-build-provenance.txt'
...
if ($id -cne 'com.moolsocial.app.cursorreview' -or $name -cne '1.0.0-r66.22-cursorreview' -or $code -cne '2026091403') { throw 'Package/version differs from authorized candidate' }
...
$receipt = [ordered]@{
  candidate=$candidate; sourceHead=$ExpectedSourceHead; applicationSource='3c30ba11521db6bb1a1ec6995b181a81df1a6b34';
  ...
  permittedDevice='TG8HCYTGGQT885OF'; installation='not_yet_performed'; childDeviceVerification='requires_subsequent_instruction'
}
