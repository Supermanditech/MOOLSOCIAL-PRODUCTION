...
$folder = Join-Path $root 'apps/mobile/build/cursor-review-r66.24'
$apk = Join-Path $folder 'artifacts/uaw-cursor-redmi-rv6-d014-repeat-20260914-device-review-debug.apk'
$provenance = Join-Path $folder 'artifacts/uaw-cursor-redmi-rv6-d014-repeat-20260914-build-provenance.txt'
...
if ($id -cne 'com.moolsocial.app.cursorreview' -or $name -cne '1.0.0-r66.24-cursorreview' -or $code -cne '2026091405') { throw 'Package/version differs from authorized candidate' }
...
$receipt = [ordered]@{
  candidate=$candidate; sourceHead=$ExpectedSourceHead; applicationSource='41412f56a4af4d75e2976dc04843dd293ae4869d';
