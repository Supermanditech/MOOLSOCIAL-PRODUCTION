# C34G pre-sealed Internal Testing browser qualification

Date: 2026-08-17 IST

State: `qualified_fresh_known_MoolSocial_Internal_testing_route_zero_C34G_Play_writes`

C34G is bound to Google Play Console Testing > Internal testing for package
...
This qualification is bound to regression registry 2,664 / SHA-256
