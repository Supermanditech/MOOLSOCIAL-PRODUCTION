...
| Screen 09 Buy | `/app/buy`, Buy V2 routes | **Complete HTML founder FINAL and locked:** immutable `screens/09-buy-complete/v1` at source SHA-256 `408A095C…` freezes Mool → Buy ownership; the always-visible Shop/Wholesale/Medicine/Orders dock; catalogues, filters, rails, product grids and decisions; prescription/pharmacist states; compact Cart; ₹ Total/Shop/Wholesale/Medicine Cart scopes; destinations; checkout, confirmation, Orders, tracking, reorder, Mool Assist and recovery. Isolated native Flutter V2 implementation is authorized but not accepted or deployable until parity, regression, exact-APK OPPO and founder gates pass. Earlier catalogue and Cart `v1` slice references remain immutable historical checkpoints. |
