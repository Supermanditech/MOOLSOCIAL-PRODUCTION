  ...
  if ($QualifiedRedmiReview) {
    ...
    if ($owner -ceq 'apps/mobile/lib/ui_v2/buy/buy_v2_screen.dart') {
      ...
      if ($soundSourceHash -cin @(
          ...
          $IntegratedReviewSourceCommit -cin @('41412f56a4af4d75e2976dc04843dd293ae4869d', '253cbe16da07f069c878bed8f0f5722b8c4aa29c', 'd6d9890fa7754a38a05b183bc8ca6e89eccf22cc', '64ca4d757cffc1cc1fa575b84004cd827e6695ab', 'f0fc06a92bb43627ec4ca952e8996a888ec96ac2') -and
