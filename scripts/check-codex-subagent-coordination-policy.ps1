...
function Assert-IntegrationRepairMerge(
  ...
  $repairOwnerClaim = @($claims | Where-Object {
    [string]$_.task -ceq '/root/repair_store_buy_conflict_v2_20260904'
  })
...
function Assert-QualifiedIntegrationRepairTip([string]$RepairCommit) {
  ...
  foreach ($preMergeCommit in $preMergeCommits) {
    ...
    Assert-Coordination (
      ...
      [string]$preMergeSubject[0] -cmatch
        '^repair\(store-buy-conflict-repair-v2-20260904\): .+' -and
  ...
  Assert-Coordination (
    ...
    [string]$repairMergeSubject[0] -cmatch
      '^repair\(store-buy-conflict-repair-v2-20260904\): .+'
...
Assert-Coordination ($continuationBindings.Count -eq 64) `
...
Assert-Coordination (
  ...
  [string]$integrationRepair.requiredCodexCommit -ceq
    '300f4247165a097d82624f4b40c9c2d611c7bc48' -and
  [string]$integrationRepair.requiredCodexBranch -ceq
    'work/codex-ui/universal-c20e-test-contract-v2-20260904' -and
  ...
  (@($integrationRepair.preMergeCoordinationOwners) -join '|') -ceq
    'docs/quality/UAW-INTEGRATION-REPAIR-STORE-BUY-V2-20260904.md' -and
  ...
  [string]$integrationRepair.freshIntegrationWorkId -ceq
    'work-store-buy-v2-20260904' -and
  [string]$integrationRepair.freshIntegrationTicketId -ceq
    'UAW-INTEGRATION-WORK-STORE-BUY-V2-20260904' -and
  [string]$integrationRepair.freshIntegrationBranch -ceq
    'integration/moolsocial/work-store-buy-v2-20260904' -and
  [string]$integrationRepair.freshIntegrationWorktreePath -ceq
    'C:/GUARANTEED OUTCOME/MOOLSOCIAL-WORKTREE-INTEGRATION-work-store-buy-v2-20260904' -and
  [string]$integrationRepair.freshIntegrationMergeSubject -ceq
    'merge(work-store-buy-v2-20260904): integrate corrected Store-Live and Buy'
  ...
  if ($ProductionPhase -cin @(
    ...
    if ($approvedBranches.Count -eq 1 -and
        [string]$approvedBranches[0] -ceq
          'work/integration-repair/store-buy-conflict-repair-v2-20260904') {
