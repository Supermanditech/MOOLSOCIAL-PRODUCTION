...
$evidence = Join-Path $root 'artifacts\quality\store-buy-diagnostic-evidence-v1-20260904'
...
$toolchain = [ordered]@{
  schema = 'moolsocial_store_buy_diagnostic_toolchain_v1'
...
$result = [ordered]@{
  schema = 'moolsocial_store_buy_serialized_diagnostic_v1'
  failedRepair = 'c48e4ecc5c3ccc7a3079d3f64988437599cc78de'
